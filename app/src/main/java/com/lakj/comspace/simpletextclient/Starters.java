...
public class Starters extends Activity {
    ...
    {
        starters_total=veg_crispy*(70)+chicken_crispy*(60)+paneer_chilly*(80)+masala_papad*(30)+veg_soup*(80)+chicken_soup*(80)+tomato_soup*(100)+cheese_pakoda*(130)+paneer_pakoda*(140)+chicken_chilly*(120);
